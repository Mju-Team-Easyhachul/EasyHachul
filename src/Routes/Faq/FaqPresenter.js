  ...
  <FaqBoardContainer>
    <FaqBoard>
      ...
      <FaqBoard>
        ...
        <FaqText3>
          <FaqTextline>
            <p>지하철과 버스는 정해진 운임요금과 승차방법으로 편리함을 제공하는 교통 수단입니다.</p>
            ★ 지하철에 부정승차 할 경우 승차 구간에 해당하는 운임 외에 30배의 범위에서 부가운임을 징수할 수 있습니다
      ...
      <FaqBoard>
        ...
        <FaqText2>Easy하철 알림</FaqText2>
        <FaqText3>
          <FaqTextline>대중교통을 타고 가다가 목적지에 황급히 내리거나, 다른곳에 집중하다 내려서 물건을 깜빡 두고 내리는 경험 있으실겁니다. 선물을 담은 쇼핑백, 비가왔던 날의 우산, 바지 뒷주머니의 지갑 등 소중한 물건을 두고 내린 순간을 알게되면 굉장히 당혹스러움을 느끼며 어떻게 찾아야할지 우왕좌왕하게 됩니다.</FaqTextline>
